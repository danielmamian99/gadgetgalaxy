      ...
      >
        <Dropdown.Trigger>
          <button
            ...
            className='h-[42px] w-[42px] p-0.5 bg-surface-gray-10 text-black bg-transparent hover:bg-button-secondary active:bg-button-secondary-hover disabled:text-terciary disabled:hover:bg-button-secondary text-body-bold-m gap-2 flex items-center justify-center border-2 border-transparent whitespace-nowrap duration-200 ease-out transition-colors flex-row rounded-3xl'
          >
            <Avatar name={user.name} avatarUrl={user.photo} size={42} />
          </button>
        </Dropdown.Trigger>
        <Dropdown.Menu className='bg-white !w-[250px] max-w-[250px] border flex flex-col shadow-x5 items-start justify-start border-surface-strokes !rounded-3xl !p-0'>
          <div className='flex flex-col items-start w-full max-h-[35vh] ui-kit-scrollbar overflow-y-auto'>
            ...
            <button className='w-full !justify-start text-black bg-transparent hover:bg-button-secondary active:bg-button-secondary-hover disabled:text-terciary disabled:hover:bg-button-secondary text-body-bold-m p-3 gap-2 flex items-center border-2 border-transparent whitespace-nowrap duration-200 ease-out transition-colors flex-row rounded-3xl'>
